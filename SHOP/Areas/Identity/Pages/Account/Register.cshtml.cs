...
namespace SHOP.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
       ...
       // private readonly IUserEmailStore<ApplicationUser> _emailStore;
        ...
        {
            // create default role if there is no roles in application 
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                user.FullUserName = Input.FullUserName;
                ...
                if (result.Succeeded)
                {
                    ...
                    // instead of creating a property in model 
                    //u can use this code 
                    string role = HttpContext.Request.Form["Role"].ToString();

                 //   string role = Input.Role;

                    if(role != null && role != "") // mean that the admin who is creating  an account now
                    {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, SDRoles.CustomerRole);
